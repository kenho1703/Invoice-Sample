...
namespace InvoiceSample.Tests.Sessions
{
    public abstract class InvoiceSampleTestBase : AbpIntegratedTestBase
    {
        protected InvoiceSampleTestBase()
        {
        ...
        protected override void AddModules(ITypeList<AbpModule> modules)
        {
            ...
            modules.Add<InvoiceSampleApplicationModule>();
            modules.Add<InvoiceSampleDataModule>();
        }

        public void UsingDbContext(Action<InvoiceSampleDbContext> action)
        {
            using (var context = LocalIocManager.Resolve<InvoiceSampleDbContext>())
            {
        ...
        public T UsingDbContext<T>(Func<InvoiceSampleDbContext, T> func)
        {
            T result;
